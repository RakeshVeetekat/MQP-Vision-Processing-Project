...
img1_org = cv2.imread('1.jpg',0)
img2_org = cv2.imread('3.jpg',0)
...
#normalize histogram
img1 = cv2.equalizeHist(img1_org)
img2 = cv2.equalizeHist(img2_org)

#run all three algorithms
# and print out how many total matches there are
runOrb()
print(amount)
...
#display matches
img3 = cv2.drawMatches(img1_org,good_kp1,img2_org,good_kp2,
	good_matches,outImg=None ,flags=2)
cv2.imshow('ensemble', img3)
k = cv2.waitKey(0)

#save image
cv2.imwrite('ensemble_dis.png', img3)
