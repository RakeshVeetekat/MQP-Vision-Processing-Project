...
imageType = input("0 for Video and Video, 1 for Video and GE, 2 for GE and GE. ")
...
data = []
data.append(['Serial Number 1','Serial Number 2', 'Match Number', 'ORB','SIFT','Shi-Tomasi','Vid and Vid','Vid and GE','GE and GE','Distance','Descriptor 1','Descriptor 2','Correctness'])
...
for i in range(0,1000):
	...
	descriptor1 = des1[matches[i].trainIdx]
	descriptor2 = des2[matches[i].queryIdx]
	...
	if k == 27:
		...
		break
	# add data to matrix
	data.append([serialNum1, serialNum2, i, orb, sift, shitomasi, VidToVid, VidToGE, GEToGE, distance, descriptor1, descriptor2,correctMatch])
